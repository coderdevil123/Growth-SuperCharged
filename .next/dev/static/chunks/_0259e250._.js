    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Cover.useEffect": ()=>{
            ...
            const updateMousePosition = {
                "Cover.useEffect.updateMousePosition": (e)=>{
                    if (!divRef.current) return;
            ...
            }["Cover.useEffect.updateMousePosition"];
...
_s(Cover, "yu+j3H3uMpPkc7UDcPsbvSQj1vE=");
_c = Cover;
var _c;
                ...
                "Home.useEffect.animate": ()=>{
                    ...
                    particles.forEach({
                        "Home.useEffect.animate": (particle, i)=>{
                            // Draw connections
                            particles.forEach({
                                "Home.useEffect.animate": (otherParticle, j)=>{
                                    if (i !== j) {
...
//# sourceMappingURL=_0259e250._.js.map